...
export default function Button({label, style}) {
    ...
    const styles = {
        ...
        secondaryShort: 'flex justify-center px-6 py-3 bg-white text-neutral-400 rounded-full items-center font-medium shadow-lg transition hover:shadow-xl hover:scale-105',
        ...
        secondaryLong: 'flex justify-center px-6 py-3 w-[320px] bg-white text-neutral-400 rounded-full items-center font-medium shadow-lg hover:shadow-xl hover:font-bold'
    }
