  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-8">
        <Accordion.Root
          className="w-[348px] max-w-[348px] shrink-0 shadow-sm shadow-black/5 flex flex-col gap-2"
          defaultValue="item-1"
          type="single"
          collapsible
        >
          <Accordion.Item id="1" value="item-1" className={itemStyle}>
            ...
            <Accordion.Content className={contentStyle}>
              <div className="p-4 pt-0">{content["item-1"].description}</div>
            </Accordion.Content>
          </Accordion.Item>
          ...
          <Accordion.Item id="2" value="item-2" className={itemStyle}>
            ...
            <Accordion.Content className={contentStyle}>
              <div className="p-4 pt-0">{content["item-2"].description}</div>
            </Accordion.Content>
          </Accordion.Item>
          ...
          <Accordion.Item id="3" value="item-3" className={itemStyle}>
            ...
            <Accordion.Content className={contentStyle}>
              <div className="p-4 pt-0">{content["item-3"].description}</div>
            </Accordion.Content>
          </Accordion.Item>
        </Accordion.Root>
